...
@Entity // spring will treat this class as database table
public class Project {
	...
	//GenerationType.SEQUENCE this can speed things up it depends on database
	...
	//we need default constructor to pass or bind default object to views 
	public Project() {
	...
	public Project(String name, String stage, String description) {
		super();
		//note project id is not here as that will be handled by database using @GeneratedValue
		this.name = name;
		this.stage = stage;
